...
namespace MyBlog.WebUI.App_Start
{
    public class AutofacConfig
    {
        ...
        public static void Register()
        {
            ...
            //告诉Autofac框架，将来要创建的控制器类存放在哪个程序集 (MyBlog.WebUI)
            Assembly controllerAss = Assembly.Load("MyBlog.WebUI");
            builder.RegisterControllers(controllerAss);
            //告诉autofac框架注册数据仓储层所在程序集中的所有类的对象实例
            Assembly respAss = Assembly.Load("MyBlog.Repository");
            ...
            Assembly serpAss = Assembly.Load("MyBlog.Services");
